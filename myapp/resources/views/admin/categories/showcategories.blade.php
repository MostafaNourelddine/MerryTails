...
<div id="container" class="p-8 bg-card shadow-lg rounded-xl font-semibold" style="margin-bottom: 6rem;">
    <input type="text" id="category-search-input" name="Search"
        class="w-[100%] bg-input px-4 py-2 rounded-xl focus:border-accent2 border-border transition-all duration-300"
        placeholder="Search Categories..." style="width:100%;">
</div>

<div id="category-list-container" class="flex flex-wrap" style="flex-wrap:wrap;justify-content:space-around">
            ...
            <form action="{{ route('admin.categories.update', $category->id) }}" method="POST"
                ...
                <div>
                    ...
                    <input type="text" id="name" name="name"
                        ...
                        placeholder="Category Name" style="width:20rem;" required value="{{ $category->name }}">
                </div>
                ...
                <div class="mt-8" style="margin-top: 1rem;">
                    ...
                    <textarea id="description" name="description"
                        class="bg-input px-4 py-2 rounded-xl focus:border-accent2 border-border"
                        placeholder="Category Description" style="width:20rem;"
    ...
    <div class="w-full text-center py-16">
        <i class="fa-solid fa-th-large text-5xl text-gray-300 mb-4"></i>
        <div class="text-gray-600 text-xl font-semibold">No categories yet</div>
        <div class="text-gray-500 mt-2">Use the form above to create your first category.</div>
    </div>
    @endforelse
</div>
